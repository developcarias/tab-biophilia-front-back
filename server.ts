// FIX: Changed express import to default and used explicit express.Request and express.Response types to resolve handler signature errors and avoid global type conflicts.
